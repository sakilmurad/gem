...
function Privacy() {
  return (
    <div>
      <h1>Privacy Policy for GeM Portal Course</h1>
      <p>
        At GeM Portal Course, accessible from{" "}
        <Link href="https://gpc.edafter.com">https://gpc.edafter.com</Link>, one
        of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by GeM Portal Course and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in GeM Portal Course. This policy is not
      ...
      <p>
        GeM Portal Course follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, GeM Portal Course uses &apos;cookies&apos;.
      ...
      <p>
        ...
        advertising partners of GeM Portal Course.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on GeM Portal Course, which are
      ...
      <p>
        Note that GeM Portal Course has no access to or control over these
      ...
      <p>
        GeM Portal Course&apos;s Privacy Policy does not apply to other
      ...
      <p>
        GeM Portal Course does not knowingly collect any Personal Identifiable
