...
function MII() {
    ...
    return (
        <div>
            <Head>
            <title>Make In India Certificate Generator for GeM - GeM Portal Course</title>
            </Head>
                <h1 className="center">Make In India Certificate Generator for GeM</h1>
    ...
    >
      ...
      <Typography sx={{ textAlign:"center", pt:margingTop }}  variant="h5" component="div">
        ...
        <Typography sx={{ textAlign:"center", m:2 }} variant="h5" component="div">
        CERTIFICATE
        </Typography>
...
<br/>
<br/>
We also understand, false declarations will be in breach of the code of integrity
under rule 175(1)(i)(h) of the General Financial Rules for which a bidder or its
