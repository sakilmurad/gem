...
function Terms() {
  return (
    <div>
      <Head>
        <title>Terms and Conditions - GeM Portal Course</title>
        <meta
          name="description"
          content="Read all about the terms and conditions of using GeM (Government e-Marketplace) Portal Course."
        />
      </Head>
      <h1>Terms and Conditions - GeM Portal Course</h1>

      <p>Welcome to GeM Portal Course!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Edafter&apos;s Website, located at{" "}
        <Link href="https://gpc.edafter.com">https://gpc.edafter.com</Link>.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use GeM Portal Course if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing GeM Portal Course, you agreed
        to use cookies in agreement with the Edafter&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Edafter and/or its licensors own the
        intellectual property rights for all material on GeM Portal Course. All
        intellectual property rights are reserved. You may access this from GeM
        Portal Course for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from GeM Portal Course</li>
        <li>Sell, rent or sub-license material from GeM Portal Course</li>
        <li>Reproduce, duplicate or copy material from GeM Portal Course</li>
        <li>Redistribute content from GeM Portal Course</li>
      </ul>
      ...
      <p>
        ...
        Edafter does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Edafter,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Edafter shall not be liable for the
      ...
      <p>
        Edafter reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Edafter a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Edafter; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Edafter. Please include your name, your organization name,
      ...
      <p>
        No use of Edafter&apos;s logo or other artwork will be allowed for
      ...
      <ul>
        <strong>Edafter</strong>
        <li>
          have right to remove any suspicious account from the GeM Portal Course
        </li>
        <li>
          have the right to remove any comment and content from GeM Portal
          Course
        </li>
        <li>
          may not refund the amount, paid by you for using any services. There
          must have valid reason to get refunded
        </li>
        <li>
          can update any document on the GeM Portal Course without prior notice
          to its users.
        </li>
      </ul>
    </div>
