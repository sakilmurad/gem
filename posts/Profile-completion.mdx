...
- **Change Business or Organisation Type** : use this section to change the business/organisation type [^note]
...
Companies and Firms are required to verify key person information as per ITR recoeds
...
[^note]: You can change the business/organisation type only once
