...
In this proccess you must have your phone number linked with your Aadhaar.
...
6. Select you Business / Organisation Type i.e: Proprietorship, Firm, Company etc.
...
10. Eneter you Aadhaar Number / Virtual ID and the Mobile number linked with the Aadhaar. After entring both tick on the consent and then "VERIFY AADHAAR"

Enter the OTP (came on the mobile number you entered) and click on "VERIFY".

11. Enter your name and check the box to confirm that you are the Key Person of the Organisation and click on "Next" Button
...
13. Once the mobile number us verified, then thick the box to confirm you are the Key Person of the Organisation and click on "NEXT" button
